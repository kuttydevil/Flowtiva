        ...
        return [
            {
                ...
                subheaderText: t('homepage.pricing.plans.starter.subheader'),
                features: [
                    t('homepage.pricing.plans.starter.f1'),
                    t('homepage.pricing.plans.starter.f2'),
                    t('homepage.pricing.plans.starter.f3'),
                    t('homepage.pricing.plans.starter.f4'),
                    t('homepage.pricing.plans.starter.f5')
                ],
                message_limit: 2000,
                account_limit: 1,
                is_popular: false
            },
            {
                id: 'pro-plan',
                name: 'Pro',
                subheader: t('homepage.pricing.plans.pro.subheader'),
                price_monthly: 149,
                price_yearly: 1490,
                description: t('homepage.pricing.plans.pro.description'),
                subheaderText: t('homepage.pricing.plans.pro.subheader'),
                features: [
                    t('homepage.pricing.plans.pro.f1'),
                    t('homepage.pricing.plans.pro.f2'),
                    t('homepage.pricing.plans.pro.f3'),
                    t('homepage.pricing.plans.pro.f4'),
                    t('homepage.pricing.plans.pro.f5'),
                    t('homepage.pricing.plans.pro.f6')
                ],
                message_limit: 10000,
                account_limit: 5,
                is_popular: true
            },
            {
                ...
                price_monthly: 299,
                price_yearly: 2990,
                description: t('homepage.pricing.plans.business.description'),
                subheaderText: t('homepage.pricing.plans.business.subheader'),
                features: [
                    t('homepage.pricing.plans.business.f1'),
                    t('homepage.pricing.plans.business.f2'),
                    t('homepage.pricing.plans.business.f3'),
                    t('homepage.pricing.plans.business.f4'),
                    t('homepage.pricing.plans.business.f5'),
                    t('homepage.pricing.plans.business.f6')
                ],
                message_limit: 30000,
                account_limit: 15,
                is_popular: false,
